...
class Box(object):
    ...
    def __init__(self, contents, volume):
        ...
        # --------------------------------------------------------------
        self.volume = volume
        self.starting_volume = volume
        if len(contents)>self.volume:
            self.contents = ""
            self.starting_contents = ""
        else:
            self.contents = contents
            self.starting_contents = contents
        self.history = []
    def append_string(self, additional_contents):
        ...
        for k in range(len(additional_contents)):
            if len(self.contents)+1 <= self.volume:
                ...
                string_not_added = string_not_added + additional_contents[k]
        return string_not_added
    ...
    def double(self):
        ...
        #    ** TWO **   LINES OF CODE.
        ################################################################
        characters_not_added = self.append_string(self.contents)
        return characters_not_added
        ...
        if new_volume < self.volume:
            for k in range(len(self.contents)):
                if k < new_volume:
                    ...
                    clipped_characters = clipped_characters + self.contents[k]
            self.contents = new_contents
        self.volume = new_volume
        return clipped_characters
    ...
    def double_then_shrink(self, new_volume):
        ...
        number_of_characters = number_of_characters + len(self.double())
        number_of_characters = number_of_characters + len(self.shrink(new_volume))
